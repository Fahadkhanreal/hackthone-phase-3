    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Join us today to start managing your tasks</p>
        </div>
        ...
        <form className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-700" onSubmit={handleSubmit}>
          ...
          <div className="text-center">
            <p className="text-gray-400 text-sm">
              ...
              <Link href="/signin" className="text-indigo-400 hover:text-indigo-300 font-medium transition-colors duration-200">
                Sign in
              </Link>
            </p>
          </div>
